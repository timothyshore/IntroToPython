...
# Tim Shore,11.22.2020,Modified code to complete assignment 6
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    @staticmethod
    def add_data_to_list(task, priority, list_of_rows):  #Menu Item 1
        dicRow = {'Task': str(task).strip(), 'Priority': str(priority).strip()}
        list_of_rows.append(dicRow)  # adds row to list
        print('Done!')
    ...
    @staticmethod
    def write_data_to_file(file_name, list_of_rows):  # menu item 3
...
class IO:
    ...
    def input_new_task_and_priority():
        ...
        print()  # adding an extra line for looks
